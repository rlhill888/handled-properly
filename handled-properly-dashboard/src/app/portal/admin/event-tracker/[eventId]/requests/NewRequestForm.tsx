...
export default function NewRequestForm({ eventId }: { eventId: string }) {
  ...
  return (
    <form ref={formRef} action={formAction} className={styles.form}>
      ...
      <div className={styles.field}>
        <label className={styles.label} htmlFor="request-type">
          Request Type
        </label>
        <select id="request-type" name="request_type" className={styles.select} defaultValue="file">
      ...
      <div className={styles.field}>
        ...
        <select id="request-fulfillment-setting" name="fulfillment_setting" className={styles.select} defaultValue="manual_review">
          <option value="manual_review">Admin reviews before marking fulfilled</option>
          <option value="auto">Fulfilled automatically as soon as the client responds</option>
        </select>
      </div>
